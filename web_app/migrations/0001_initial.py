# Generated by Django 4.2.8 on 2024-01-11 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('V', 'Vendor'), ('C', 'Customer'), ('S', 'Shipper'), ('A', 'Admin')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_app.user')),
